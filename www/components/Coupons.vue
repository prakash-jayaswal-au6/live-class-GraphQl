...
<script>
import COUPONS from '~/../gql/coupon/coupons.gql'
import COUPON from '~/../gql/coupon/coupon.gql'
import SAVE_COUPON from '~/../gql/coupon/saveCoupon.gql'
// import DELETE_COUPON from '~/gql/coupon/deleteCoupon.gql'
