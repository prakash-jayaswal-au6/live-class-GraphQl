...
const settingSchema = new Schema(
  {
    ...
    currency_decimals: { type: Number, default: 2 },
    ...
    email: {
      ...
      from: { type: String, default: 'lrnr.in <no-reply@lrnr.in>' },
      printers: { type: Array, default: ['lrnr.in <print@hpeprint.com>'] },
      cc: { type: Array, default: ['Swadesh Behera <swadesh@lrnr.in>'] },
      bcc: { type: Array, default: ['Customer Service <care@lrnr.in>'] },
    },
    login: {
      FACEBOOK_ID: String,
